...
const AnnouncementBar = () => {
  ...
  return (
    <div className="h-10 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-36 flex justify-between items-center bg-black">
      {/* social media icons */}
      <div className="flex gap-3">
       ...
       <LangSwitch /> {/* ⬅️ вот здесь будет кнопка */}
      {/* Country name */}
      <div className="">
        <p className="text-white text-xs wai font-normal"> {t('country')} (AZN, &#8380;)</p>
      </div>
    </div>
  );
};
